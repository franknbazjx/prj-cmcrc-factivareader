...
public class LoginUSYD extends Login {
    ...
    private String post(String para, String url, String referer) throws IOException {
...
//        LOG.info(rsp);
    ...
    private String extractParameter(String resp, String pat, String format) {
...
//            LOG.info("8:" + newurl);
    ...
    private String getRedirectUrl(HttpMethod method) {
